...
public class PrintfFormatTest
{
        ...
        boolean alt, boolean zeropad, boolean left, boolean blank, boolean sign)
    {
        ...
        if (fmt.type != type)
        {
            System.out.println("type is '" + fmt.type + "' vs. '" + type + "'");
        }
        else if (!streq(fmt.prefix, pfx))
        {
            System.out.println("prefix is '" + fmt.prefix + "' vs. '" + pfx +
                "'");
        }
        else if (!streq(fmt.suffix, sfx))
        {
            System.out.println("suffix is '" + fmt.suffix + "' vs. '" + sfx +
                "'");
        }
        else if (fmt.width != w)
        {
            System.out.println("width is " + fmt.width + " vs. " + w);
        }
        else if (fmt.prec != p)
        {
            System.out.println("prec is " + fmt.prec + " vs. " + p);
        }
        else if (fmt.alternate != alt)
        {
            System.out.println("alternate is " + fmt.alternate + " vs. " + alt);
        }
        else if (fmt.zeropad != zeropad)
        {
            System.out.println("zeropad is " + fmt.zeropad + " vs. " + zeropad);
        }
        else if (fmt.leftAdjust != left)
        {
            System.out.println("leftAdjust is " + fmt.leftAdjust + " vs. " +
                left);
        }
        else if (fmt.addBlank != blank)
        {
            System.out.println("addBlank is " + fmt.addBlank + " vs. " + blank);
        }
        else if (fmt.addSign != sign)
        {
            System.out.println("addSign is " + fmt.addSign + " vs. " + sign);
        }
        else
        {
            pass = true;
