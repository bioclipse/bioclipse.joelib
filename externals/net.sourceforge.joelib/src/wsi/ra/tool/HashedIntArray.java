///////////////////////////////////////////////////////////////////////////////
//Filename: $RCSfile: HashedIntArray.java,v $
...
public class HashedIntArray
{
     ...
     */
    public HashedIntArray(int[] _array)
    {
        array = _array;
    }
     ...
     */
    public final int get(int _index)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        else if (obj instanceof HashedIntArray)
        {
            HashedIntArray tmpObj = (HashedIntArray) obj;
    ...
    public static void main(String[] args)
    {
        ...
        HashedIntArray hashArr = new HashedIntArray();

        hashArr.setArray(test);
        System.out.println("" + (index++) + " Hash: " + hashArr.hashCode() +
            " from: " + hashArr.toString());
        test = new int[]{2, 3, 4, 5, 6, 20};
        hashArr.setArray(test);
        System.out.println("" + (index++) + " Hash: " + hashArr.hashCode() +
            " from: " + hashArr.toString());
        test = new int[]{0, 2, 3, 4, 5, 6};
        hashArr.setArray(test);
        System.out.println("" + (index++) + " Hash: " + hashArr.hashCode() +
            " from: " + hashArr.toString());
        test = new int[]{2, 3, 4, 5, 6, 0};
        hashArr.setArray(test);
        System.out.println("" + (index++) + " Hash: " + hashArr.hashCode() +
            " from: " + hashArr.toString());
        test = new int[]{1, 2, 3, 5, 6, 10};
        hashArr.setArray(test);
        System.out.println("" + (index++) + " Hash: " + hashArr.hashCode() +
            " from: " + hashArr.toString());
        test = new int[]{1, 2, 3, 4, 5, 20};
        hashArr.setArray(test);
        System.out.println("" + (index++) + " Hash: " + hashArr.hashCode() +
            " from: " + hashArr.toString());
