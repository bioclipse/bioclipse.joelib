...
public class DataPlot3D
{
    ...
    public DataPlot3D(double[] x, double[] y, double[] z, double[] wX,
        double[] wY, double[] wZ, Axe3D ax, int typ, Color col)
    {
        axe = ax;
    ...
    public void draw(Graphics2D comp2D)
    {
        ...
        case 4:
            ...
            for (int i = 0; i < points.length; i++)
            {
                ...
                comp2D.drawLine(points[i].getSc()[0], points[i].getSc()[1],
                    pointbase.getSc()[0], pointbase.getSc()[1]);
            }
        ...
        case 6:
            ...
            for (int i = 0; i < points.length; i++)
            {
                ...
                Coordinates3D pt1 = pointbase.addVector(-widthX[i] / 2,
                        -widthY[i] / 2, 0);
                Coordinates3D pt2 = pointbase.addVector(widthX[i] / 2,
                        -widthY[i] / 2, 0);
                Coordinates3D pt3 = pointbase.addVector(-widthX[i] / 2,
                        widthY[i] / 2, 0);
                Coordinates3D pt4 = pointbase.addVector(widthX[i] / 2,
                        widthY[i] / 2, 0);
                Coordinates3D pt5 = points[i].addVector(-widthX[i] / 2,
                        -widthY[i] / 2, 0);
                Coordinates3D pt6 = points[i].addVector(widthX[i] / 2,
                        -widthY[i] / 2, 0);
                Coordinates3D pt7 = points[i].addVector(-widthX[i] / 2,
                        widthY[i] / 2, 0);
                Coordinates3D pt8 = points[i].addVector(widthX[i] / 2,
                        widthY[i] / 2, 0);
                ...
                comp2D.drawLine(pt5.getSc()[0], pt5.getSc()[1], pt6.getSc()[0],
                    pt6.getSc()[1]);
                comp2D.drawLine(pt6.getSc()[0], pt6.getSc()[1], pt8.getSc()[0],
                    pt8.getSc()[1]);
                comp2D.drawLine(pt8.getSc()[0], pt8.getSc()[1], pt7.getSc()[0],
                    pt7.getSc()[1]);
                comp2D.drawLine(pt7.getSc()[0], pt7.getSc()[1], pt5.getSc()[0],
                    pt5.getSc()[1]);

                comp2D.drawLine(pt1.getSc()[0], pt1.getSc()[1], pt5.getSc()[0],
                    pt5.getSc()[1]);
                comp2D.drawLine(pt2.getSc()[0], pt2.getSc()[1], pt6.getSc()[0],
                    pt6.getSc()[1]);
                comp2D.drawLine(pt3.getSc()[0], pt3.getSc()[1], pt7.getSc()[0],
                    pt7.getSc()[1]);
                comp2D.drawLine(pt4.getSc()[0], pt4.getSc()[1], pt8.getSc()[0],
                    pt8.getSc()[1]);
            }
