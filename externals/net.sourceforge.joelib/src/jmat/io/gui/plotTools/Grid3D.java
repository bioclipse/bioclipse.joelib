...
public class Grid3D
{
    ...
    public void draw(Graphics2D comp2D)
    {
        ...
        for (int i = 0; i < Pl_Xgrid.length; i++)
        {
            ...
            comp2D.drawLine(Sc_Xgrid[i][0][3], Sc_Xgrid[i][1][3],
                Sc_Xgrid[i][0][4], Sc_Xgrid[i][1][4]);
        ...
        for (int j = 0; j < Pl_Ygrid.length; j++)
        {
            ...
            comp2D.drawLine(Sc_Ygrid[j][0][3], Sc_Ygrid[j][1][3],
                Sc_Ygrid[j][0][4], Sc_Ygrid[j][1][4]);
        ...
        {
            comp2D.drawLine(Sc_Zgrid[k][0][0], Sc_Zgrid[k][1][0],
                Sc_Zgrid[k][0][1], Sc_Zgrid[k][1][1]);
            comp2D.drawLine(Sc_Zgrid[k][0][3], Sc_Zgrid[k][1][3],
                Sc_Zgrid[k][0][4], Sc_Zgrid[k][1][4]);
            comp2D.drawString(troncatedStringZ(Pl_Zgrid[k][2][2], 0),
                Sc_Zgrid[k][0][2], Sc_Zgrid[k][1][2]);
        }
    }
    ...
    {
        Xpow = Math.floor(Math.log((Pl_XMax[0] - Pl_XMin[0]) / numGrid) /
                Math.log(10));
        ...
        Ypow = Math.floor(Math.log((Pl_YMax[1] - Pl_YMin[1]) / numGrid) /
                Math.log(10));
        ...
        Zpow = Math.floor(Math.log((Pl_ZMax[2] - Pl_ZMin[2]) / numGrid) /
                Math.log(10));
