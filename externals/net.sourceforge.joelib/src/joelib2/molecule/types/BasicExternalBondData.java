///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: BasicExternalBondData.java,v $
 ...
 */
public class BasicExternalBondData extends BasicPairData
    implements java.io.Serializable, ExternalBondData
{
     ...
     */
    public void setData(Atom atom, Bond bond, int idx)
    {
        if (externalBonds == null)
        {
            externalBonds = new Vector<BasicExternalBond>();
        }

        BasicExternalBond xb = new BasicExternalBond(atom, bond, idx);
        externalBonds.add(xb);
    }
}
