///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: CombineExample.java,v $
...
public class CombineExample
{
    ...
    private static Category logger = Category.getInstance(CombineExample.class
            .getName());
    ...
    public boolean parseCommandLine(String[] args)
    {
        if (args[0].indexOf("-i") == 0)
        {
            ...
            if (inType1 == null)
            {
                logger.error("Input type '" + inputTypeName1 +
                    "' not defined.");
        ...
        if (args[2].indexOf("-i") == 0)
        {
            ...
            if (inType2 == null)
            {
                logger.error("Input type '" + inputTypeName2 +
                    "' not defined.");
    ...
    public void test()
    {
        if ((inType1 == null) || (inputFile1 == null) || (inType2 == null) ||
                (inputFile2 == null) || (outType == null) ||
                (outputFile == null))
        {
        ...
        for (;;)
        {
            ...
            try
            {
                ...
                //                    System.exit(1);
                //                }
                // check if the title of the molecule is equal
                if (checkIfSameTitle)
                {
                    if ((mol1.getTitle() != null) && (mol2.getTitle() != null))
                    {
                        ...
                        {
                            logger.warn("Different molecules: " +
                                mol1.getTitle() + " " + mol2.getTitle() + " ?");
                ...
                //        if (VERBOSE)
                //        {
                //          System.out.println("write " + mol1.toString(verboseType));
                //        }
            ...
            if ((molCounter % 500) == 0)
            {
                logger.info("... " + molCounter +
                    " molecules successful combined in " +
                    watch.getPassedTime() + " ms.");
            }
        }

        logger.info("... " + molCounter + " molecules successful combined in " +
            watch.getPassedTime() + " ms.");
    }
