///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: BondIsPrimaryAmide.java,v $
 ...
 */
public class BondIsPrimaryAmide extends AbstractDynamicBondProperty
{
    ...
    private static Category logger = Category.getInstance(
            BondIsPrimaryAmide.class.getName());
    private static final Class[] DEPENDENCIES =
        new Class[]
        {
            AtomIsCarbon.class, AtomIsNitrogen.class, BondIsCarbonyl.class,
            AtomHeavyValence.class
        };
    ...
    {
        return BondIsPrimaryAmide.class.getName();
    }
     ...
     */
    public static boolean isPrimaryAmide(Bond bond)
    {
        boolean isPAmide = false;
        Atom atom1;
        Atom atom2;
        atom1 = atom2 = null;
        ...
        else
        {
            ...
            while (bit.hasNext())
            {
                ...
                {
                    if (AtomHeavyValence.valence(atom2) == 2)
                    {
                        isPAmide = true;
