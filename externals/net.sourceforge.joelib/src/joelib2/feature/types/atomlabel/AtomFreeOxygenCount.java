///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomFreeOxygenCount.java,v $
 ...
 */
public class AtomFreeOxygenCount extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(
            AtomFreeOxygenCount.class.getName());
    private static final Class[] DEPENDENCIES =
        new Class[]{AtomIsOxygen.class, AtomHeavyValence.class};
    ...
    public static int getIntValue(Atom atom)
    {
        ...
        try
        {
            freeOxygens = AtomPropertyHelper.getIntAtomProperty(atom, getName(),
                    true);
        }
    ...
    {
        return AtomFreeOxygenCount.class.getName();
    }
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            freeOCount[atomIdx - 1] = AbstractFreeOxygenCount.calculate(atom);
        }
