///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomElectronAffinity.java,v $
 ...
 */
public class AtomElectronAffinity extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(
            AtomElectronAffinity.class.getName());
    ...
    {
        return AbstractElectronAffinity.calculate(atom);
    }

    public static String getName()
    {
        return AtomElectronAffinity.class.getName();
    }
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        double[] elAffin = (double[]) DynamicArrayResult.getNewArray(
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            elAffin[atomIdx - 1] = AbstractElectronAffinity.calculate(atom);
        }
