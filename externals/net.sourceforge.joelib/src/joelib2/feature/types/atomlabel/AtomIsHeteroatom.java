///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomIsHeteroatom.java,v $
 ...
 */
public class AtomIsHeteroatom extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(AtomIsHeteroatom.class
            .getName());
    private static final Class[] DEPENDENCIES =
        new Class[]{AtomIsHalogen.class};
    ...
    {
        return AtomIsHeteroatom.class.getName();
    }
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            heteroatom[atomIdx - 1] = isHeteroatom(atom);
        }
