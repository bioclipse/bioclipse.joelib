///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomIsSulfateOxygen.java,v $
 ...
 */
public class AtomIsSulfateOxygen extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(
            AtomIsSulfateOxygen.class.getName());
    private static final Class[] DEPENDENCIES =
        new Class[]
        {
            AtomIsOxygen.class, AtomHeavyValence.class, AtomIsSulfur.class,
    ...
    {
        return AtomIsSulfateOxygen.class.getName();
    }
    ...
    public static boolean isSulfateOxygen(Atom thisAtom)
    {
        boolean isSO = false;
        ...
        else
        {
                    ...
                    (AtomHeavyValence.valence(thisAtom) == 1))
            {
                ...
                while (bit.hasNext())
                {
                    ...
                    if (AtomIsSulfur.isSulfur((bond.getNeighbor(thisAtom))))
                    {
                ...
                if ((atom != null) &&
                        (AtomFreeOxygenCount.getIntValue(atom) >= 3))
                {
                    isSO = true;
                }
            }
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        boolean[] sulfateOxygen = (boolean[]) DynamicArrayResult.getNewArray(
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            sulfateOxygen[atomIdx - 1] = isSulfateOxygen(atom);
        }

        return sulfateOxygen;
    }
