///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomIsClockwise.java,v $
 ...
 */
public class AtomIsClockwise extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(AtomIsClockwise.class
            .getName());
    ...
    {
        return AtomIsClockwise.class.getName();
    }
    ...
    public static boolean isClockwise(Atom atom)
    {
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        boolean[] clockwise = (boolean[]) DynamicArrayResult.getNewArray(
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            clockwise[atomIdx - 1] = isClockwise(atom);
        }
