///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomInRingsCount.java,v $
 ...
 */
public class AtomInRingsCount extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(AtomInRingsCount.class
            .getName());
    private static final Class[] DEPENDENCIES =
        new Class[]{AtomInRing.class, RingFinderSSSR.class};
    ...
    public static int getIntValue(Atom atom)
    {
        ...
        try
        {
            inRings = AtomPropertyHelper.getIntAtomProperty(atom, getName());
        }
    ...
    {
        return AtomInRingsCount.class.getName();
    }
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        int[] inRingCount = (int[]) DynamicArrayResult.getNewArray(
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            inRingCount[atomIdx - 1] = AbstractInRingsCount.calculate(atom);
        }
