///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomIsAntiClockwise.java,v $
 ...
 */
public class AtomIsAntiClockwise extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(
            AtomIsAntiClockwise.class.getName());
    ...
    {
        return AtomIsAntiClockwise.class.getName();
    }
    ...
    public static boolean isAntiClockwise(Atom atom)
    {
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        boolean[] anticlockwise = (boolean[]) DynamicArrayResult.getNewArray(
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            anticlockwise[atomIdx - 1] = isAntiClockwise(atom);
        }
