///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomIsNitroOxygen.java,v $
 ...
 */
public class AtomIsNitroOxygen extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(
            AtomIsNitroOxygen.class.getName());
    private static final Class[] DEPENDENCIES =
        new Class[]
        {
            AtomIsOxygen.class, AtomHeavyValence.class, AtomIsNitrogen.class,
    ...
    {
        return AtomIsNitroOxygen.class.getName();
    }
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        boolean[] nitroOxygen = (boolean[]) DynamicArrayResult.getNewArray(
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            nitroOxygen[atomIdx - 1] = isNitroOxygen(atom);
        }
    ...
    /**
      ...
      */
    public boolean isNitroOxygen(Atom thisAtom)
    {
        boolean isNO = false;
        ...
        else
        {
                    ...
                    (AtomHeavyValence.valence(thisAtom) == 1))
            {
                ...
                while (bit.hasNext())
                {
                    ...
                    if (AtomIsNitrogen.isNitrogen(bond.getNeighbor(thisAtom)))
                    {
