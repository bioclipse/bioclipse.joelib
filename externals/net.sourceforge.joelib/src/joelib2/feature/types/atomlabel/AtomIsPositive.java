///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomIsPositive.java,v $
...
public class AtomIsPositive extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(AtomIsPositive.class
            .getName());
    ...
    {
        return AtomIsPositive.class.getName();
    }
    ...
    public static boolean isPositive(Atom atom)
    {
    ...
    {
        int numAtoms = mol.getAtomsSize();
        boolean[] positive = (boolean[]) DynamicArrayResult.getNewArray(
                DynamicArrayResult.BOOLEAN, numAtoms);

        Atom atom;

        for (int atomIdx = 1; atomIdx <= numAtoms; atomIdx++)
        {
            atom = mol.getAtom(atomIdx);
            positive[atomIdx - 1] = isPositive(atom);
        }
