///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomENSanderson.java,v $
 ...
 */
public class AtomENSanderson extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(AtomENSanderson.class
            .getName());
    ...
    {
        return AbstractENSanderson.calculate(atom);
    }

    public static String getName()
    {
        return AtomENSanderson.class.getName();
    }
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            elNeg[atomIdx - 1] = AbstractENSanderson.calculate(atom);
        }
