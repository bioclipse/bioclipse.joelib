///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomFreeElectronsCount.java,v $
 ...
 */
public class AtomFreeElectronsCount extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(
            AtomFreeElectronsCount.class.getName());
    private static final Class[] DEPENDENCIES =
        new Class[]{BasicElementHolder.class, AtomImplicitValence.class};
    ...
    public static int getIntValue(Atom atom)
    {
        ...
        try
        {
            freeEl = AtomPropertyHelper.getIntAtomProperty(atom, getName(),
                    true);
        }
    ...
    {
        return AtomFreeElectronsCount.class.getName();
    }
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        int[] freeOCount = (int[]) DynamicArrayResult.getNewArray(
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            freeOCount[atomIdx - 1] = AbstractFreeElectronsCount.calculate(
                    atom);
        }
