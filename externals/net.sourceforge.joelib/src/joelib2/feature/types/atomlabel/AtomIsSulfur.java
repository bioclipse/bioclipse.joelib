///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomIsSulfur.java,v $
 ...
 */
public class AtomIsSulfur extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(AtomIsSulfur.class
            .getName());
    ...
    {
        return AtomIsSulfur.class.getName();
    }
    ...
    public static boolean isSulfur(Atom atom)
    {
        return (atom.getAtomicNumber() == 16);
    }

    public Object getAtomPropertiesArray(Molecule mol)
    {
        int atomsSize = mol.getAtomsSize();
        boolean[] sulfur = (boolean[]) DynamicArrayResult.getNewArray(
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            sulfur[atomIdx - 1] = isSulfur(atom);
        }
