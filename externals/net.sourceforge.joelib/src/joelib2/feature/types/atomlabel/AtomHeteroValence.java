///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomHeteroValence.java,v $
 ...
 */
public class AtomHeteroValence extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(
            AtomHeteroValence.class.getName());
    private static final Class[] DEPENDENCIES =
        new Class[]{AtomIsHeteroatom.class};
    ...
    {
        return AbstractHeteroValence.calculate(atom);
    }

    public static String getName()
    {
        return AtomHeteroValence.class.getName();
    }
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            valence[atomIdx - 1] = AbstractHeteroValence.calculate(atom);
        }
