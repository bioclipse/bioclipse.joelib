///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomIsHydrogen.java,v $
 ...
 */
public class AtomIsHydrogen extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(AtomIsHydrogen.class
            .getName());
    ...
    {
        return AtomIsHydrogen.class.getName();
    }
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        boolean[] hydrogen = (boolean[]) DynamicArrayResult.getNewArray(
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            hydrogen[atomIdx - 1] = isHydrogen(atom);
        }
