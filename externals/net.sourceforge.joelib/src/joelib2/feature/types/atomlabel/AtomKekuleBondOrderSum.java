///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomKekuleBondOrderSum.java,v $
 ...
 */
public class AtomKekuleBondOrderSum extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(
            AtomKekuleBondOrderSum.class.getName());
    ...
    public static int getIntValue(Atom atom)
    {
        ...
        try
        {
            kekuleSum = AtomPropertyHelper.getIntAtomProperty(atom, getName(),
                    true);
        }
    ...
    {
        return AtomKekuleBondOrderSum.class.getName();
    }
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        {
            atom = ait.nextAtom();
            boSum[arrIdx++] = AbstractKekuleBondOrderSum.calculate(atom);
        }
