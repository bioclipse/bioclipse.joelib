///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomIsOxygen.java,v $
 ...
 */
public class AtomIsOxygen extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(AtomIsOxygen.class
            .getName());
    ...
    {
        return AtomIsOxygen.class.getName();
    }
    ...
    public static boolean isOxygen(Atom atom)
    {
        return (atom.getAtomicNumber() == 8);
    }

    public Object getAtomPropertiesArray(Molecule mol)
    {
        int atomsSize = mol.getAtomsSize();
        boolean[] oxygen = (boolean[]) DynamicArrayResult.getNewArray(
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            oxygen[atomIdx - 1] = isOxygen(atom);
        }
