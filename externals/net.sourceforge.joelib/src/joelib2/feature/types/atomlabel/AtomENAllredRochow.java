///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomENAllredRochow.java,v $
 ...
 */
public class AtomENAllredRochow extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(
            AtomENAllredRochow.class.getName());
    ...
    public static double electronegativity(Atom atom)
    {
        return AbstractENAllredRochow.calculate(atom);
    }
    ...
    {
        return AtomENAllredRochow.class.getName();
    }
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            elNeg[atomIdx - 1] = AbstractENAllredRochow.calculate(atom);
        }
