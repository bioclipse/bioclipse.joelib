///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomIsNegative.java,v $
 ...
 */
public class AtomIsNegative extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(AtomIsNegative.class
            .getName());
    ...
    {
        return AtomIsNegative.class.getName();
    }
    ...
    public static final boolean isNegative(Atom atom)
    {
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        boolean[] negative = (boolean[]) DynamicArrayResult.getNewArray(
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            negative[atomIdx - 1] = isNegative(atom);
        }
