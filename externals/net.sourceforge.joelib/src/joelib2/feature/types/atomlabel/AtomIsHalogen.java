///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomIsHalogen.java,v $
 ...
 */
public class AtomIsHalogen extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(AtomIsHalogen.class
            .getName());
    ...
    {
        return AtomIsHalogen.class.getName();
    }
    ...
    */
    ...
    {
        return AtomHelper.isElementOfGroup(atom, 7);
    }

    public Object getAtomPropertiesArray(Molecule mol)
    {
        int atomsSize = mol.getAtomsSize();
        boolean[] halogen = (boolean[]) DynamicArrayResult.getNewArray(
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            halogen[atomIdx - 1] = isHalogen(atom);
        }
