///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomExplicitHydrogenCount.java,v $
 ...
 */
public class AtomExplicitHydrogenCount extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(
            AtomExplicitHydrogenCount.class.getName());
     ...
     */
    public AtomExplicitHydrogenCount()
    {
    ...
    public static int getIntValue(Atom atom)
    {
        ...
        try
        {
            expH = AtomPropertyHelper.getIntAtomProperty(atom, getName());
        }
    ...
    {
        return AtomExplicitHydrogenCount.class.getName();
    }
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        int[] expHCount = (int[]) DynamicArrayResult.getNewArray(
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            expHCount[atomIdx - 1] = AbstractExplicitHydrogenCount.calculate(
                    atom);
        }
