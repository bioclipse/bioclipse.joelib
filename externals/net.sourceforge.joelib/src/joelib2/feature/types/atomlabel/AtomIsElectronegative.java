///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomIsElectronegative.java,v $
 ...
 */
public class AtomIsElectronegative extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(
            AtomIsElectronegative.class.getName());
    ...
    {
        return AtomIsElectronegative.class.getName();
    }
     ...
     */
    public static boolean isElectronegative(Atom atom)
    {
        return ((atom.getAtomicNumber() == 7) ||
                (atom.getAtomicNumber() == 8) ||
                (atom.getAtomicNumber() == 9) ||
                (atom.getAtomicNumber() == 17) ||
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        boolean[] enegative = (boolean[]) DynamicArrayResult.getNewArray(
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            enegative[atomIdx - 1] = isElectronegative(atom);
        }
