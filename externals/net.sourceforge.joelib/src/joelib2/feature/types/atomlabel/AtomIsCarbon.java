///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AtomIsCarbon.java,v $
 ...
 */
public class AtomIsCarbon extends AbstractDynamicAtomProperty
{
    ...
    private static Category logger = Category.getInstance(AtomIsCarbon.class
            .getName());
    ...
    {
        return AtomIsCarbon.class.getName();
    }
    ...
    public static boolean isCarbon(Atom atom)
    {
    ...
    public Object getAtomPropertiesArray(Molecule mol)
    {
        ...
        for (int atomIdx = 1; atomIdx <= atomsSize; atomIdx++)
        {
            ...
            carbon[atomIdx - 1] = isCarbon(atom);
        }
