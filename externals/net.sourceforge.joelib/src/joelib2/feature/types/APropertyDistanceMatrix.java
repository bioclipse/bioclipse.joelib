///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: APropertyDistanceMatrix.java,v $
...
public class APropertyDistanceMatrix implements Feature
{
    ...
    private static Category logger = Category.getInstance(
            APropertyDistanceMatrix.class.getName());
    private static final Class[] DEPENDENCIES = new Class[]{APropertyBFS.class};
     ...
     */
    public APropertyDistanceMatrix()
    {
        descInfo = FeatureHelper.generateFeatureInfo(this.getClass(),
                BasicFeatureInfo.TYPE_TOPOLOGICAL, null,
                IntMatrixResult.class.getName());
    }
    ...
    {
        Molecule mol = (Molecule) molOrig.clone(true);
        mol.deleteHydrogens();
        ...
        try
        {
            ...
            {
                bfs[i] = FeatureFactory.getFeature(APropertyBFS.getName());
