///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AromaticOHGroups.java,v $
//  Purpose:  Number of aromatic hydroxy groups.
//  Language: Java
//  Compiler: JDK 1.4
...
public class AromaticOHGroups extends AbstractSMARTSCounter
{
    ...
    private static Category logger = Category.getInstance(AromaticOHGroups.class
            .getName());
    public final static String DEFAULT = "[OX2;H1;$(O-a)]";
    ...
    {
        return AromaticOHGroups.class.getName();
    }
