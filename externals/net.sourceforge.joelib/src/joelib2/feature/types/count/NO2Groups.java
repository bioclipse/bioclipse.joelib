///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: NO2Groups.java,v $
//  Purpose:  Number of NO2 groups.
//  Language: Java
//  Compiler: JDK 1.4
 ...
 */
public class NO2Groups extends AbstractSMARTSCounter
{
    ...
    private static Category logger = Category.getInstance(NO2Groups.class
            .getName());
    public final static String DEFAULT = "[#7D3;$(N(~O)~O)]-*";
    ...
    {
        return NO2Groups.class.getName();
    }
