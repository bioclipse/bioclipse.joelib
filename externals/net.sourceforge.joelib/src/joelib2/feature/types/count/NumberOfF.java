///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: NumberOfF.java,v $
//  Purpose:  Number of fluor atoms.
//  Language: Java
//  Compiler: JDK 1.4
...
/**
 * Number of fluor atoms.
 *
 * @.author     wegnerj
 * @.license    GPL
 * @.cvsversion    $Revision: 1.9 $, $Date: 2005/02/17 16:48:32 $
 */
public class NumberOfF extends AbstractAtomsCounter
{
    ...
    private static Category logger = Category.getInstance(NumberOfF.class
            .getName());
    private static int[] DEFAULT =
        new int[]{BasicElementHolder.instance().getAtomicNum("F")};
    ...
    {
        return NumberOfF.class.getName();
    }
