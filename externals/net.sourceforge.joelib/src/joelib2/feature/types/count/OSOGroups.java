///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: OSOGroups.java,v $
//  Purpose:  Number of OSO groups.
//  Language: Java
//  Compiler: JDK 1.4
 ...
 */
public class OSOGroups extends AbstractSMARTSCounter
{
    ...
    private static Category logger = Category.getInstance(OSOGroups.class
            .getName());
    public final static String DEFAULT = "[#16D2;$(S(~O)~O)]-*";
    ...
    {
        return OSOGroups.class.getName();
    }
