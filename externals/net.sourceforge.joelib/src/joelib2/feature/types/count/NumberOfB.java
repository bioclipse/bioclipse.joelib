///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: NumberOfB.java,v $
//  Purpose:  Number of bor atoms.
//  Language: Java
//  Compiler: JDK 1.4
 ...
 */
public class NumberOfB extends AbstractAtomsCounter
{
    ...
    private static Category logger = Category.getInstance(NumberOfB.class
            .getName());
    private static int[] DEFAULT =
        new int[]{BasicElementHolder.instance().getAtomicNum("B")};
    ...
    {
        return NumberOfB.class.getName();
    }
