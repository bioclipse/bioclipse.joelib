///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: NumberOfN.java,v $
//  Purpose:  Number of nitrogen atoms.
//  Language: Java
//  Compiler: JDK 1.4
...
public class NumberOfN extends AbstractAtomsCounter
{
    ...
    private static Category logger = Category.getInstance(NumberOfN.class
            .getName());
    private static int[] DEFAULT =
        new int[]{BasicElementHolder.instance().getAtomicNum("N")};
