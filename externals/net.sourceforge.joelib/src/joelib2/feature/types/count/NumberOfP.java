///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: NumberOfP.java,v $
//  Purpose:  Number of phospor atoms.
//  Language: Java
//  Compiler: JDK 1.4
...
/**
 * Number of phospor atoms.
 *
 * @.author     wegnerj
 * @.license    GPL
 * @.cvsversion    $Revision: 1.9 $, $Date: 2005/02/17 16:48:32 $
 */
public class NumberOfP extends AbstractAtomsCounter
{
    ...
    private static Category logger = Category.getInstance(NumberOfP.class
            .getName());
    private static int[] DEFAULT =
        new int[]{BasicElementHolder.instance().getAtomicNum("P")};
    ...
    {
        return NumberOfP.class.getName();
    }
