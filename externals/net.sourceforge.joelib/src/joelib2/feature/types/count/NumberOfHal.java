 ...
 */
public class NumberOfHal extends AbstractAtomsCounter
{
    ...
    private static Category logger = Category.getInstance(NumberOfHal.class
            .getName());
    private static int[] DEFAULT =
        new int[]
        {
            BasicElementHolder.instance().getAtomicNum("F"),
            BasicElementHolder.instance().getAtomicNum("Cl"),
            BasicElementHolder.instance().getAtomicNum("Br"),
            BasicElementHolder.instance().getAtomicNum("I"),
            BasicElementHolder.instance().getAtomicNum("At")
        };
    ...
    {
        return NumberOfHal.class.getName();
    }
