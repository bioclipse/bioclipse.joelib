///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: HBA2.java,v $
//  Purpose:  Number of Hydrogen Bond Acceptors (HBA).
//  Language: Java
//  Compiler: JDK 1.4
 ...
 */
public class HBA2 extends AbstractSMARTSCounter
{
    ...
    private static Category logger = Category.getInstance(HBA2.class.getName());
