///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: NumberOfCl.java,v $
//  Purpose:  Number of chlor atoms.
//  Language: Java
//  Compiler: JDK 1.4
...
/**
 * Number of chlor atoms.
 *
 * @.author     wegnerj
 * @.license    GPL
 * @.cvsversion    $Revision: 1.9 $, $Date: 2005/02/17 16:48:32 $
 */
public class NumberOfCl extends AbstractAtomsCounter
{
    ...
    private static Category logger = Category.getInstance(NumberOfCl.class
            .getName());
    private static int[] DEFAULT =
        new int[]{BasicElementHolder.instance().getAtomicNum("Cl")};
    ...
    {
        return NumberOfCl.class.getName();
    }
