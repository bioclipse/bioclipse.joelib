///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: SOGroups.java,v $
//  Purpose:  Number of SO groups.
//  Language: Java
//  Compiler: JDK 1.4
 ...
 */
public class SOGroups extends AbstractSMARTSCounter
{
    ...
    private static Category logger = Category.getInstance(SOGroups.class
            .getName());
    public final static String DEFAULT = "[#16D2;$(S~O);!$(S(~O)~O)]-*";
