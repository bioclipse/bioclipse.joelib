///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: BasicGroups.java,v $
//  Purpose:  Number of basic groups.
//  Language: Java
//  Compiler: JDK 1.4
 ...
 */
public class BasicGroups extends AbstractSMARTSCounter
{
    ...
    private static Category logger = Category.getInstance(BasicGroups.class
            .getName());
    ...
    {
        return BasicGroups.class.getName();
    }
