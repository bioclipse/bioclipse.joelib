///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: NumberOfO.java,v $
//  Purpose:  Number of oxygen atoms.
//  Language: Java
//  Compiler: JDK 1.4
 ...
 */
public class NumberOfO extends AbstractAtomsCounter
{
    ...
    private static Category logger = Category.getInstance(NumberOfO.class
            .getName());
    private static int[] DEFAULT =
        new int[]{BasicElementHolder.instance().getAtomicNum("O")};
    ...
    {
        return NumberOfO.class.getName();
    }
