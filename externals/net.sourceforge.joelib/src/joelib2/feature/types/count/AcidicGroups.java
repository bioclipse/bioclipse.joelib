///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AcidicGroups.java,v $
//  Purpose:  Number of acidic groups.
//  Language: Java
//  Compiler: JDK 1.4
...
public class AcidicGroups extends AbstractSMARTSCounter
{
    ...
    private static Category logger = Category.getInstance(AcidicGroups.class
            .getName());
    public final static String DEFAULT =
        "[$([O;H1]-[C,S,P]=O),$([*;-;!$(*~[*;+])]),$([NH](S(=O)=O)C(F)(F)F),$(n1nnnc1),$(n1nncn1)]";
