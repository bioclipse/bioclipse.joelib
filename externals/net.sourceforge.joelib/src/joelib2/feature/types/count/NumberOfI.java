///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: NumberOfI.java,v $
//  Purpose:  Number of iod atoms.
//  Language: Java
//  Compiler: JDK 1.4
 ...
 */
public class NumberOfI extends AbstractAtomsCounter
{
    ...
    private static Category logger = Category.getInstance(NumberOfI.class
            .getName());
    private static int[] DEFAULT =
        new int[]{BasicElementHolder.instance().getAtomicNum("I")};
    ...
    {
        return NumberOfI.class.getName();
    }
