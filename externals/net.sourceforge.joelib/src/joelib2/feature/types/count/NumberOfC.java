///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: NumberOfC.java,v $
//  Purpose:  Number of carbon atoms.
//  Language: Java
//  Compiler: JDK 1.4
 ...
 */
public class NumberOfC extends AbstractAtomsCounter
{
    ...
    private static Category logger = Category.getInstance(NumberOfC.class
            .getName());
    private static int[] DEFAULT =
        new int[]{BasicElementHolder.instance().getAtomicNum("C")};
    ...
    {
        return NumberOfC.class.getName();
    }
