///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: NumberOfS.java,v $
//  Purpose:  Number of sulfur atoms.
//  Language: Java
//  Compiler: JDK 1.4
 ...
 */
public class NumberOfS extends AbstractAtomsCounter
{
    ...
    private static Category logger = Category.getInstance(NumberOfS.class
            .getName());
    private static int[] DEFAULT =
        new int[]{BasicElementHolder.instance().getAtomicNum("S")};
    ...
    {
        return NumberOfS.class.getName();
    }
