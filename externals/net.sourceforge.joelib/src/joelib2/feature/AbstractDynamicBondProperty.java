///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AbstractDynamicBondProperty.java,v $
 ...
 */
public abstract class AbstractDynamicBondProperty implements Feature
{
    ...
    private static Category logger = Category.getInstance(
            AbstractDynamicBondProperty.class.getName());
     ...
     */
    public abstract Object getBondPropertiesArray(Molecule mol);
        ...
        Map properties) throws FeatureException
    {
        ...
        else
        {
            ...
            if (initialize(properties))
            {
                ...
                Object array = getBondPropertiesArray(mol);
