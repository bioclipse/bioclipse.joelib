///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: AbstractBoolean.java,v $
...
public abstract class AbstractBoolean implements Feature
{
     ...
     */
    private static Category logger = Category.getInstance(AbstractBoolean.class
            .getName());
     ...
     *
     * @param the molecule
     * @return the boolean descriptor value
     */
    public abstract boolean getBooleanValue(Molecule mol);
    ...
    {
        if (!(descResult instanceof BooleanResult))
        {
            logger.error(descInfo.getName() + " result should be of type " +
                BooleanResult.class.getName() + " but it's of type " +
        ...
        {
            result = (BooleanResult) descResult;
            result.setBoolean(getBooleanValue(mol));
