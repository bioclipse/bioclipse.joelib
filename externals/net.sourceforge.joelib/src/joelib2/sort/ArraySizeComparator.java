///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: ArraySizeComparator.java,v $
...
/**
 *  <tt>Comparator</tt> for array size (int or double).
 *
 * @.author     wegnerj
 * @.license GPL
...
public class ArraySizeComparator implements Comparator
{
    ...
    /**
     *  Initializes the <tt>ArraySizeComparator</tt>-<tt>Comparator</tt>.
     */
    public ArraySizeComparator()
    {
    }
    ...
    public int compare(Object o1, Object o2)
    {
        ...
        else
        {
            throw new ClassCastException(
                "Objects must be of type int[] or double[].");
        }
    }
    ...
    {
        if (obj instanceof ArraySizeComparator)
        {
            return true;
        }
