///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: SingleTieResolverENGrad.java,v $
 ...
 */
public class SingleTieResolverENGrad implements SingleTieResolver
{
    //~ Methods ////////////////////////////////////////////////////////////////
    ...
    {
        double tmp = 5 +
            (AtomENPauling.getDoubleValue(mol.getAtom(ap.atomIdx)) -
                AtomENPauling.getDoubleValue(mol.getAtom(ap.parent)));
