///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: SingleTieResolverImpVal.java,v $
 ...
 */
public class SingleTieResolverImpVal implements SingleTieResolver
{
    //~ Methods ////////////////////////////////////////////////////////////////

    public double getResolvingValue(AtomDoubleParent ap, Molecule mol)
    {
        return (double) AtomImplicitValence.getImplicitValence(mol.getAtom(
                    ap.atomIdx));
    }
