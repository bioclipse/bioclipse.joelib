///////////////////////////////////////////////////////////////////////////////
//  Filename: $RCSfile: SimpleGUIExample.java,v $
...
public class SimpleGUIExample extends javax.swing.JFrame
{
    ...
    private static Category logger = Category.getInstance(SimpleGUIExample.class
            .getName());
    ...
    */
    ...
    void process_actionPerformed(ActionEvent e)
    {
        ...
        case 0:
            ...
            ((ConvertPanel) convertPanel).startConvert(inputFile.getText(),
                outputFile.getText());
        ...
        case 1:
            ...
            ((StatisticPanel) statisticPanel).startStatistic(inputFile
                .getText(), outputFile.getText());

            break;

        //                  case 2: logger.info("Process selection"); break;
        }
    }
    ...
    private void initComponents()
    {
        ...
        JOELibTestGUIActionListener frameAction =
            new JOELibTestGUIActionListener();
        ...
        if (dummyURL != null)
        {
            ...
            //openFileIcon.setImage(openFileIcon.getImage().getScaledInstance(95,28,Image.SCALE_AREA_AVERAGING));
            openFileIcon.setImage(openFileIcon.getImage().getScaledInstance(64,
                    19, Image.SCALE_AREA_AVERAGING));
        }
        else
        {
        ...
        if (dummyURL != null)
        {
            ...
            closeFileIcon.setImage(closeFileIcon.getImage().getScaledInstance(
                    64, 19, Image.SCALE_AREA_AVERAGING));
        }
        else
        {
            logger.error("Could not load icon " + path);
        ...
        if (dummyURL != null)
        {
            ...
            smartsFileIcon.setImage(smartsFileIcon.getImage().getScaledInstance(
                    64, 19, Image.SCALE_AREA_AVERAGING));
        }
        else
        {
        ...
        if (dummyURL != null)
        {
            ...
            //processIcon.setImage(processIcon.getImage().getScaledInstance(64, 19, Image.SCALE_AREA_AVERAGING));
        }
        else
        {
            logger.error("Could not load icon " + path);
        ...
        //applicationsTabs.addTab("Selection", selectionPanel);
